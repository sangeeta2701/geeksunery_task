...
//
//     final movieListData = movieListDataFromJson(jsonString);

import 'dart:convert';

MovieListData movieListDataFromJson(String str) => MovieListData.fromJson(json.decode(str));

String movieListDataToJson(MovieListData data) => json.encode(data.toJson());
...
class MovieListData {
    ...
    factory MovieListData.fromJson(Map<String, dynamic> json) => MovieListData(
